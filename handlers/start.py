...
def _commands_for_locale(locale: str) -> list[BotCommand]:
    if locale == "en":
        ...
        if MULTI_USER_MODE:
            commands.insert(2, BotCommand("team", "Manage participants"))
        return commands
    ...
    if MULTI_USER_MODE:
        commands.insert(2, BotCommand("team", "Управление участниками"))
    return commands
...
async def handle_help(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if MULTI_USER_MODE:
        text += "• /team — управление участниками (удаление лишних)\n"
    text += (
        "• /help — это сообщение\n\n"
    ...
    if MULTI_USER_MODE:
        text += "5) Добавь участников и нажми «Сохранить событие».\n\n"
        text += (
            "👥 Участники:\n"
        ...
        text += "5) Нажми «Сохранить событие».\n\n"
